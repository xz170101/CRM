		...
		function editsave() {
			...
			$.ajax({
				...
				data:{
					 ...
					 stu_ZiXunName:$("#stu_ZiXunName33").textbox("getValue"),
...
<body>
	...
	<!-- 查看窗体 -->
	<div id="lookStu" class="easyui-dialog" title="查看学生信息" style="width:635px;height:450px;" 
	...
	buttons:[{
		...
		<div id="cc" class="easyui-layout" style="width:600px;height:450px;">   
	    <div data-options="region:'west',title:'在线录入',split:true"  style="height:600px;padding:5px;background:#eee;">
	...
	<!-- 修改窗体 -->
	<div id="editStu" class="easyui-dialog" title="修改学生信息" style="width:600;height:450px;" 
	data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true,
	buttons:[{
				text:'保存',
				handler:function(){
		...
		<div id="cc" class="easyui-layout" style="width:600px;height:450px;">   
	    <div data-options="region:'west',title:'在线录入',split:true"  style="height:500px;padding:5px;background:#eee;">
		
	    <form id="editStuForm11" class="easyui-form">
	    	<table cellpadding="5">
	    		<tr>
	    			<td>编号：</td>
	    			<td><input class="easyui-textbox" disabled="disabled" id="sid1" name="stu_id"/></td>
	    		</tr>
	    		<tr>
	    			<td>姓名:</td>
